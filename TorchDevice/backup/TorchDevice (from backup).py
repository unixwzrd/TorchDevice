...
class TorchDevice:
    ...
    def apply_patches(cls):
        ...
        if hasattr(torch, 'cuda') and hasattr(torch.cuda, 'Stream'):
            torch.cuda.Stream = cls.mock_cuda_stream

        log_info("Patches applied", device_type=cls.get_default_device())

        # Note: TTS-specific patches have been removed as they don't belong in the general TorchDevice library
        # Application-specific patches should be implemented in the application code itself
