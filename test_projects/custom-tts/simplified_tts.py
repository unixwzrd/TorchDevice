...
"""
Simplified TTS with TorchDevice.
This script demonstrates using Coqui TTS with TorchDevice by using a simpler approach.
"""
...
# Create a custom wrapper for torch.device
original_torch_device = torch.device

def patched_device(*args, **kwargs):
    logger.info(f"Patched torch.device called with args: {args}, kwargs: {kwargs}")
    return original_torch_device(*args, **kwargs)
...
def print_device_info():
    ...
    logger.info("============================================================")
    logger.info("Simplified TTS with TorchDevice")
    logger.info("============================================================")
...
def test_basic_tts(output_path="samples/simplified_output.wav"):
    ...
    try:
        ...
        # Generate speech
        text = "Hello, this is a test of the simplified TorchDevice library with text to speech."
...
def main():
    ...
    try:
        ...
        # Restore original torch.device
        torch.device = original_torch_device
