...
"""
Integrated TTS with TorchDevice.
...
def test_basic_tts(output_path="samples/integrated_output.wav"):
...
def main():
    ...
    if success:
        ...
        logger.info("The audio file has been saved to samples/integrated_output.wav")
