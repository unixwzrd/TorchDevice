...
"""
Patched TTS with TorchDevice integration.
This script demonstrates using Coqui TTS with TorchDevice by patching torch.device.
"""
...
def print_device_info():
    ...
    logger.info("============================================================")
    logger.info("Patched TTS with TorchDevice")
    logger.info("============================================================")
